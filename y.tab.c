...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from tp2.y  */
...
const int YY_parse_CLASS::pal=259;
const int YY_parse_CLASS::OPA=260;
const int YY_parse_CLASS::OPR=261;
const int YY_parse_CLASS::BEGINP=262;
const int YY_parse_CLASS::MIDDLE=263;
const int YY_parse_CLASS::ENDP=264;
const int YY_parse_CLASS::SEP=265;
const int YY_parse_CLASS::IF=266;
const int YY_parse_CLASS::ENDIF=267;
const int YY_parse_CLASS::WHILE=268;
const int YY_parse_CLASS::ENDWHILE=269;
const int YY_parse_CLASS::ELSE=270;
const int YY_parse_CLASS::PARESQ=271;
const int YY_parse_CLASS::PARDIR=272;
...
static const short yyprhs[] = {     0,
     0,     6,     8,    12,    14,    17,    21,    23,    25,    27,
    31,    33,    37,    39,    41,    47,    52,    59
};

static const short yyrhs[] = {     7,
    19,     8,    21,     9,     0,    20,     0,    20,    10,    19,
     0,     4,     0,    22,    10,     0,    22,    10,    21,     0,
    23,     0,    27,     0,    28,     0,    20,    10,    24,     0,
    25,     0,    25,     5,    24,     0,     3,     0,     4,     0,
    16,    25,     6,    25,    17,     0,    11,    26,    21,    12,
     0,    11,    26,    21,    15,    21,    12,     0,    13,    26,
    21,    14,     0
};
...
static const short yyrline[] = { 0,
    29,    31,    32,    35,    38,    39,    42,    43,    44,    47,
    50,    51,    54,    55,    58,    61,    62,    65
};

static const char * const yytname[] = {   "$","error","$illegal.","num","pal",
"OPA","OPR","BEGINP","MIDDLE","ENDP","SEP","IF","ENDIF","WHILE","ENDWHILE","ELSE",
"PARESQ","PARDIR","programa","declaracoes","variavel","instrucoes","instrucao",
"atribuicao","expressao","valor","comp","condicao","ciclo",""
};
#endif

static const short yyr1[] = {     0,
    18,    19,    19,    20,    21,    21,    22,    22,    22,    23,
...
static const short yydefact[] = {     0,
     0,     4,     0,     2,     0,     0,     0,     0,     0,     0,
     0,     7,     8,     9,     3,     0,     0,     0,     0,     1,
     5,    13,    14,     0,     0,     0,    10,    11,     6,     0,
    16,     0,    18,     0,     0,     0,    12,    15,    17,     0,
     0,     0
};

static const short yydefgoto[] = {    40,
     3,     9,    10,    11,    12,    27,    28,    17,    13,    14
};

static const short yypact[] = {     0,
    13,-32768,     1,     8,    -1,    13,     3,     3,    11,    14,
    12,-32768,-32768,-32768,-32768,    10,    -1,    -1,    10,-32768,
    -1,-32768,-32768,    18,    -7,     6,-32768,    20,-32768,    10,
-32768,    -1,-32768,    10,     9,    15,-32768,-32768,-32768,    28,
    29,-32768
};

static const short yypgoto[] = {-32768,
    24,     5,   -17,-32768,-32768,    -3,   -14,    25,-32768,-32768
};
...
static const short yytable[] = {    25,
    26,    24,     2,    29,    31,     4,     1,    32,     5,     7,
     4,     8,    22,    23,    36,    35,     2,     6,    16,    33,
    19,    21,    20,    30,    34,    38,    39,    41,    42,    15,
    37,     0,    18
};

static const short yycheck[] = {    17,
    18,    16,     4,    21,    12,     1,     7,    15,     8,    11,
     6,    13,     3,     4,    32,    30,     4,    10,    16,    14,
    10,    10,     9,     6,     5,    17,    12,     0,     0,     6,
    34,    -1,     8
};
...
case 12:
#line 51 "tp2.y"
{ yyval.vali=yyvsp[-2].vali+yyvsp[0].vali; printf("## s%d\n",yyval.vali ); ;
    break;}
case 13:
#line 54 "tp2.y"
{ { printf("%d\n", yyvsp[0].vali); yyval.vali=yyvsp[0].vali; } ;
    break;}
case 14:
#line 55 "tp2.y"
{ { printf("%s\n", yyvsp[0].vals); } ;
